...
public class iKittenModel : MonoBehaviour {
	...
	public void equipItem(int itemSelectIndex) {
		state.itemEquipped = InventoryModel.use.obtainableItems[""+itemSelectIndex].getInternalName();
	}
	
	public string getEquippedItemName() {
		return state.itemEquipped;
	}
