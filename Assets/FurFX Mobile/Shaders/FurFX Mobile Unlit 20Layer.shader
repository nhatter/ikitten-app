...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.049987793, -1, 1, 0.0025000002 },
...
"vs_2_0
; 28 ALU
def c19, 0.04998779, 1.00000000, -1.00000000, 0.00250000
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.05) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.0025) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
PARAM c[6] = { program.local[0..3],
		{ 0.0025005341, 0.81445313, 0.049987793, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
...
dcl_2d s0
dcl_2d s1
def c4, 0.81445313, 0.00250053, 0.04998779, 1.00000000
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.15002441, -1, 1, 0.022500001 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.15002441, 1.00000000, -1.00000000, 0.02250000
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.15) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.0225) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.022506714, 0.52197266, 0.15002441, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.52197266, 0.02250671, 0.15002441, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"vs_2_0
; 28 ALU
def c19, 0.25000000, 1.00000000, -1.00000000, 0.06250000
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.25) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.0625) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
dcl_2d s0
dcl_2d s1
def c4, 0.31640625, 0.06250000, 0.25000000, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.35009766, -1, 1, 0.12249999 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.35009766, 1.00000000, -1.00000000, 0.12249999
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.35) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.1225) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.12249756, 0.1784668, 0.35009766, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.17846680, 0.12249756, 0.35009766, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.44995117, -1, 1, 0.20249999 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.44995117, 1.00000000, -1.00000000, 0.20249999
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.45) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.2025) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.20251465, 0.091491699, 0.44995117, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.09149170, 0.20251465, 0.44995117, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.54980469, -1, 1, 0.30250001 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.54980469, 1.00000000, -1.00000000, 0.30250001
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.55) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.3025) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.30249023, 0.041015625, 0.54980469, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.04101563, 0.30249023, 0.54980469, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.64990234, -1, 1, 0.42249995 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.64990234, 1.00000000, -1.00000000, 0.42249995
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.65) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.4225) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.42260742, 0.015007019, 0.64990234, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.01500702, 0.42260742, 0.64990234, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"vs_2_0
; 28 ALU
def c19, 0.75000000, 1.00000000, -1.00000000, 0.56250000
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.75) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.5625) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
dcl_2d s0
dcl_2d s1
def c4, 0.00390625, 0.56250000, 0.75000000, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.85009766, -1, 1, 0.72250003 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.85009766, 1.00000000, -1.00000000, 0.72250003
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.85) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.7225) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
# 13 ALU, 2 TEX
PARAM c[6] = { program.local[0..3],
		{ 0.72265625, 0.00050640106, 0.85009766, -1 },
		{ 1, 0 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
dcl_2d s0
dcl_2d s1
def c4, 0.00050640, 0.72265625, 0.85009766, 1.00000000
def c5, 0.00000000, 1.00000000, 0, 0
dcl t0
dcl v0.xyz
texld r0, t0, s0
...
"!!ARBvp1.0
# 27 ALU
PARAM c[20] = { { 0.95019531, -1, 1, 0.90249997 },
		state.matrix.projection,
		state.matrix.mvp,
		program.local[9..19] };
TEMP R0;
...
"vs_2_0
; 28 ALU
def c19, 0.95019531, 1.00000000, -1.00000000, 0.90249997
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mov r0, c13
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _NoiseTex_ST.xy) + _NoiseTex_ST.zw);
  highp vec3 tmpvar_2;
  tmpvar_2 = (_glesVertex.xyz + (((normalize (_glesNormal) * _FurLength) * 0.95) * _HairHardness));
  P = tmpvar_2;
  highp vec3 tmpvar_3;
  tmpvar_3 = (P + ((((_World2Object * clamp (_ForceGlobal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz + (gl_ProjectionMatrix * clamp (_ForceLocal, vec4(-1.0, -1.0, -1.0, -1.0), vec4(1.0, 1.0, 1.0, 1.0))).xyz) * 0.9025) * _FurLength));
  P = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4.w = 1.0;
  tmpvar_4.xyz = P;
...
dcl_2d s0
dcl_2d s1
def c3, 0.90234375, 0.95019531, 1.00000000, 0.00000000
dcl t0
dcl v0.xyz
texld r0, t0, s0
max_pp r1.x, r0.w, c2
add_pp r1.x, -r1, c3.y
cmp r1.x, -r1, c3.z, -c3.z
cmp r1.x, r1, c3.w, c3.z
mov_pp r1, -r1.x
mov r2.y, t0.w
mov r2.x, t0.z
mul_pp r2.xy, r2, c1.x
...
texkill r1.xyzw
mov_pp r1.x, c0
mad_pp_sat r0.w, c3.x, -r1.x, r2.x
mov_pp oC0, r0
"
}
